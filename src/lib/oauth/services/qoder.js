  ...
  async fetchUserInfo(accessToken) {
    try {
      ...
      return {
        ...
        // user_id is required for COSY signing — expose it so bulk import
        // can use it as fallback when pollDeviceToken returns an empty user_id.
        userId: (body.user_id || body.id || "").trim(),
      };
    } catch {
      return { name: "", email: "" };
    }
