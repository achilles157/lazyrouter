// Durable proxy-pool fitness registry (ported from VansRouter).
// Scope format: `provider::model` (for example `freebuff::openai/gpt-5.6-luna`).
...
const FITNESS_STATE_KEY = "__lazyrouterPoolFitness__";
